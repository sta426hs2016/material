...
| 21.11.2016  | Mark  | edgeR+friends 2  | [Adjusting batch effects in microarray expression data using empirical Bayes methods](http://biostatistics.oxfordjournals.org/content/8/1/118.long) <br> {KH, SS}  | x |
